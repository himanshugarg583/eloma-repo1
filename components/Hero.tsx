...
export default function Hero({ ready }: { ready: boolean }) {
  return (
    <section id="top" className="relative h-[100svh] w-full overflow-hidden bg-gradient-to-br from-paper via-white to-paper">
      ...
      <div className="relative z-10 grid h-full w-full grid-cols-1 lg:grid-cols-2">
        ...
        >
          ...
          {/* Main Heading */}
          <h1 className="font-serif font-light leading-[1.0] text-navy">
            <RevealText
              text="The Living"
              by="word"
            ...
            <RevealText
              text="Enterprise"
              by="word"
              className="block text-5xl sm:text-6xl lg:text-7xl italic text-grad"
              delay={0.55}
            />
          </h1>
        ...
        <div className="relative hidden flex-col items-center justify-center lg:flex">
          ...
          >
            <h2 className="font-serif text-4xl font-light leading-[1.2] text-white md:text-5xl drop-shadow-lg">
              <span className="block text-bold-400">Connected</span>
              <span className="block text-bold-300">Globally</span>
            </h2>
