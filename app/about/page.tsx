...
const timeline = [
  {
    date: "Jan 2018",
    body: "Eloma Group was founded in Sydney with a focus on building a unified global business platform across logistics, technology and trade."
  },
  {
    date: "April 2019",
    body: "Registered as a strategic partner across our key supply-chain verticals — beginning a multi-year journey of category leadership in each market."
  },
  {
    date: "May 2020",
    body: "Launched our first proprietary platform: an integrated operations layer powering visibility, route optimisation and KPI reporting at scale."
  },
  {
    date: "August 2021",
    body: "Expanded as Nintex, AWS, Microsoft and Google Cloud partners — embedding cross-cloud capability across every Eloma business unit."
  },
  {
    date: "July 2022",
    body: "Even though we started with just five people, within four years we grew to 400+ specialists — a testament to our culture and growth."
  },
  {
    date: "December 2024",
    body: "Became a Summit Consulting Partner with a single objective: delivering lasting value to every client across every engagement."
  }
];
...
const values = [
  ...
  { icon: Lightbulb,    title: "Innovation & Continuous Learning" },
  { icon: Sparkles,     title: "Fun" },
  { icon: ShieldCheck,  title: "Trust & Accountability" },
  { icon: Users,        title: "Team Spirit" },
  { icon: Zap,          title: "Work Hard & Fast" },
  { icon: Rocket,       title: "Freedom With Responsibility" },
  { icon: Globe2,       title: "Communication" },
  { icon: Award,        title: "Transparency & Mutual Respect" }
];
...
const faqs = [
  {
    q: "How do we start a partnership with Eloma?",
    a: "We begin with a discovery sprint to align on vision, scope, and success metrics across our verticals. Most engagements move from first meeting to delivery within 4 weeks."
  },
  {
    q: "Which industries does Eloma serve?",
    a: "Logistics, transportation, technology, virtual security, travel & tourism, and customer support — across eight countries with a single integrated standard."
  },
  {
    q: "What makes Eloma's delivery model different?",
    a: "We combine advisory, execution, and governance under one accountable leadership team — so clients experience one Eloma, not five business units."
  },
  {
    q: "Where does Eloma operate?",
    a: "Australia, India, USA, Canada, UK, China, Singapore, and UAE — with regional leadership in each market and unified operating standards across all of them."
  },
  {
    q: "What other digital transformation services do you offer apart from logistics?",
    a: "Cloud platforms, data engineering, virtual security, customer support automation, and travel-services digitisation — engineered to work together as one stack."
  }
];
...
function AboutHero() {
  return (
    <section className="relative isolate overflow-hidden pt-28 md:pt-32">
      ...
      <div className="container-x relative flex min-h-[60vh] flex-col items-center justify-end pb-12 text-center md:min-h-[68vh] md:pb-16">
        <motion.h1
      ...
      <div className="container-x grid items-start gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
        ...
        >
          ...
          <div className="mt-8 space-y-5 text-base leading-relaxed text-slate-600 md:text-lg">
            <p>
              The story of Eloma began at the most unexpected of places — a
              small regional office. Five individuals with the same mindset
              decided to challenge conventional norms and push the boundaries
              of what an integrated business group could be.
            </p>
            <p>
              The team&apos;s constant focus on self-improvement and refusal to
              settle for mediocrity enabled us to grow our numbers to 400+
              highly talented specialists across eight countries. We aim to not
              only offer services but also establish lasting relationships with
              all our customers.
            </p>
          </div>
        </motion.div>
  ...
  const cards = [
    {
      ...
      accent: "bg-gold",
      body: [
        "Our Mission is 'leveraging technology through our people to keep our clients at the pinnacle of excellence.'",
        "At Eloma we aim to make a tangible impact on our client's businesses by creating solutions which not only optimise their business processes but help them serve their customers better — making them a market leader in their landscape."
      ]
    },
    {
      title: "Our Vision",
      accent: "bg-forest",
      body: [
        "Our vision is to become a global leader in the digital transformation industry, drive innovation, and shape the future of businesses by challenging conventional thinking and pushing the boundaries of what's possible.",
        "Leading to a long-lasting connection with our clients and partners based on trust and exceptional experience."
      ]
    }
  ];
      ...
      <div className="container-x">
        ...
        >
          ...
          <p className="mt-5 text-base leading-relaxed text-slate-600 md:text-lg">
            These are the values, beliefs, and principles that guide our
            organisation&apos;s behaviour and decision-making. They are the
            foundation of Eloma&apos;s culture and shape how we interact with
        ...
        <div className="grid items-center gap-10 rounded-[32px] border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-8 shadow-card-hover md:grid-cols-[1fr_1fr] md:p-12">
          ...
          <div className="space-y-5">
            <p className="text-base leading-relaxed text-slate-600 md:text-lg">
              We are trusted by exceptional brands as well as SMEs across many
              industries — only because we believe in providing real value and
              easing complex business processes with our integrated solutions.
            </p>
            <Link
              href="#"
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[auto_1fr] lg:gap-16">
          ...
          >
            <h2 className="font-display text-3xl font-bold leading-tight text-slate-700 md:text-4xl lg:text-5xl">
              Become a{" "}
              <span className="text-gold-dark">Next-Gen Business</span> with us!
            </h2>
            <Link
              href="#contact"
