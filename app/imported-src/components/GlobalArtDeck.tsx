...
export function GlobalArtDeck() {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Initial state: already fanned out (like the screenshot)
      gsap.set(cardElements[0], { x: -260 - 110, y: -60 - 140, rotation: -25, scale: 1 });
      gsap.set(cardElements[1], { x: -180 - 110, y: -40 - 140, rotation: -15, scale: 1 });
      gsap.set(cardElements[2], { x: -90 - 110, y: -20 - 140, rotation: -8, scale: 1 });
      gsap.set(cardElements[3], { x: 0 - 110, y: 0 - 140, rotation: 0, scale: 1 });
      gsap.set(cardElements[4], { x: 90 - 110, y: -20 - 140, rotation: 8, scale: 1 });
      gsap.set(cardElements[5], { x: 180 - 110, y: -40 - 140, rotation: 15, scale: 1 });
      gsap.set(cardElements[6], { x: 260 - 110, y: -60 - 140, rotation: 25, scale: 1 });
