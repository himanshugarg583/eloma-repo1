  ...
  return (
    ...
    >
      <div className="container-x">
        ...
        >
          {/* Parallax bg image — layer is taller than the panel (overscan) so the
              ±15% vertical drift never reveals an empty edge while scrolling. */}
          <motion.div
            className="absolute inset-x-0 -top-[25%] h-[150%] -z-10"
            style={{ y: bgY }}
          >
            <Image
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='220' height='220'><filter id='n'><feTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='2' stitchTiles='stitch'/></filter><rect width='100%25' height='100%25' filter='url(%23n)'/></svg>\")"
            }}
          />
