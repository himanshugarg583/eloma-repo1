    ...
    >
      <div className="container-x">
        ...
        <div className="relative mt-5">
          {/* Ambient green orb for warmth behind the grid */}
          <motion.div
            aria-hidden
            className="pointer-events-none absolute left-1/2 top-1/4 -z-10 h-[460px] w-[460px] -translate-x-1/2 rounded-full bg-gold/10 blur-3xl"
            ...
            {services.map((service, idx) => (
              ...
              >
                <TiltCard maxTilt={6} className="h-full">
                  <div className="group relative isolate flex h-full flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white p-7 transition-all duration-500 hover:-translate-y-1 hover:border-forest hover:shadow-card-hover md:p-8">
