      ...
      <section className="min-h-screen relative flex items-center justify-center overflow-hidden px-6 md:px-12 py-[80px] md:py-[100px] 3xl:py-[120px] 4xl:py-[140px]" style={{ perspective: '1200px' }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10 w-full max-w-[1400px] mx-auto">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center text-left relative z-20">
            ...
            <h2 className="text-[34px] sm:text-[44px] 3xl:text-[64px] 4xl:text-[78px] font-black tracking-[-2px] leading-[1.1] text-[#111] mb-6">
              Be a Part of Our<br />
              <span className="text-[#3dbf9e]">Sustainable Journey</span>
            </h2>

            <h3 className="text-[13px] 3xl:text-[15px] 4xl:text-[16px] font-black tracking-[3px] uppercase text-[#1a56ff] mb-4">Together, We Can Build a Better Future</h3>

            <p className="text-[14px] 3xl:text-[19px] 4xl:text-[22px] text-[#444] leading-[1.75] mb-5 font-semibold">
            ...
            <div className="p-6 rounded-[20px] bg-neutral-50/80 border border-black/5 shadow-[inset_0_1px_0_rgba(255,255,255,0.6)] relative overflow-hidden">
              ...
              <p className="text-[12.5px] 3xl:text-[15px] 4xl:text-[16px] text-[#666] leading-[1.65] font-medium relative z-10">
          ...
          <div className="lg:col-span-7 relative w-full h-[380px] sm:h-[480px] lg:h-[580px] 3xl:h-[760px] 4xl:h-[900px] flex items-center justify-center transform-style-3d overflow-hidden lg:overflow-visible">
            <div ref={containerRef} className="relative w-[580px] h-[520px] transform-style-3d scale-[0.6] sm:scale-[0.85] lg:scale-100 3xl:scale-[1.3] 4xl:scale-[1.48] origin-center">
