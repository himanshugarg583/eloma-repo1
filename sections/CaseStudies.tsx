  ...
  return (
    ...
    >
      ...
      <div className="sticky top-10 flex h-screen flex-col justify-center overflow-visible py-12 mt-20">
        ...
        <div className="mt-5 mb-8 hidden lg:flex container-x items-start overflow-visible relative" ref={containerRef}>
          <motion.div
            ref={trackRef}
            style={{ x }}
          ...
          >
            {caseStudies.map((study, idx) => (
              <Link
                key={study.title}
                href="#"
                className="group relative flex min-w-[360px] md:w-[420px] flex-shrink-0 flex-col overflow-visible rounded-2xl border border-slate-200 bg-white shadow-card transition-all duration-500 hover:border-forest hover:shadow-card-hover h-auto"
              >
        ...
        <div className="container-x mt-10 grid gap-6 md:grid-cols-2 lg:hidden">
          {caseStudies.map((study) => (
            <Link
              key={study.title}
              href="#"
              className="group flex flex-col overflow-visible rounded-2xl border border-slate-200 bg-white shadow-card transition-all duration-500 hover:-translate-y-1 hover:border-forest hover:shadow-card-hover"
            >
