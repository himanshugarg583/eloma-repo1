...
export const stats = [
  ...
  { label: "Daily deliveries", value: 3200 },
  { label: "Innovation labs", value: 6 }
];

export const caseStudies = [
  {
    title: "Global FMCG Network Rebuild",
    description: "Reduced lead time by 36 percent across three regions."
  },
  {
    title: "Pharma Cold Chain Excellence",
    description: "Zero deviation compliance for regulated products worldwide."
  },
  {
    title: "Automobile JIT Acceleration",
    description: "Streamlined inbound parts with predictive delivery orchestration."
  }
];
...
export const blogPosts = [
  {
    ...
    description: "How luxury-grade logistics is redefining global supply chains."
  },
  {
    title: "Sustainable Infrastructure at Scale",
    description: "A new standard for greener, smarter logistics networks."
  },
  {
    title: "AI-Driven Visibility",
    description: "Turning complex operations into transparent, decisive systems."
  }
];
